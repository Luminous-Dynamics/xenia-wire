...
mod tests {
    ...
    fn deterministic_selection_and_binding_match_native_vectors() {
        ...
        assert_eq!(
            ...
            [
                0xa4, 0x86, 0x15, 0xf6, 0xc5, 0xb7, 0x00, 0x4a, 0xa1, 0x9c, 0xd5, 0x7e, 0x34,
                0x23, 0x5c, 0xa3, 0x57, 0x75, 0xdf, 0xe0, 0xab, 0xd1, 0x04, 0x8c, 0x55, 0x95,
                0xfe, 0x20, 0xa8, 0xb5, 0x55, 0xe8,
            ]
        );
        assert_eq!(
    ...
    fn manufactured_selection_and_duplicate_inputs_fail_closed() {
        ...
        let manufactured = NegotiatedContextV1::from_capabilities([cap(
            b"xenia.causal-authority",
            b"draft-04",
        )])
        .unwrap();
